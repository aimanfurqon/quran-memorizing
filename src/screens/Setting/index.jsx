      ...
      <SafeAreaView>
        <View style={styles.container}>
          ...
          >
            ...
            <Text style={{ fontSize: 16, marginLeft: 8, color: "#969696" }}>
              Halaman Utama
            </Text>
          </TouchableOpacity>
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("PersonalizationConfig", {
                  saveMemorizationProgress: false,
                })
              }
            >
            ...
            <TouchableOpacity
              ...
              //   }
            >
              <Ionicons name="book-outline" size={16} color="#8a8a8a" />
              <Text style={{ marginLeft: 8, fontWeight: "500" }}>
                Mode Penanda Baris Hafalan
              </Text>
            </TouchableOpacity>
          </View>
          <View
